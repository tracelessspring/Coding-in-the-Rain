...
public class Add_Task_Frame extends JFrame{
	...
	public void reset(){
		...
		jlb_idoremail.setText(str_jlb_idoremail);
		jlb_weiboemailcontent.setText("微博内容:");
		jtf_taskname.setText(str_taskname);
		jtf_date.setText(str_date);
		jtf_time.setText(str_time);
		jtf_receiveemail.setText(str_receiveemail);
		jpf_emailkey.setText(str_emailkey);
	...
	public void init(){
		...
		jlb_framename=new JLabel("新建任务",JLabel.CENTER);
		jlb_taskname=new JLabel("任务名称:");
		...
		//System.out.println("add_task_frame+1");
	}
	...
	public Add_Task_Frame(){
		...
		jtf_taskname.getDocument().addDocumentListener(new DocumentListener(){
			public void insertUpdate(DocumentEvent e){
				str_taskname=jtf_taskname.getText();
		...
		jb_ok.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				Runner.task[Runner.count_task]=new Task(str_taskname,jcb1.getSelectedIndex(),str_date,
				...
				Checkordelete_Task_Frame.fresh_taskname();
